...
<div class="table-wrap" style="padding:0 var(--spacing-md) var(--spacing-md);">
  ...
  <table class="cyber-table">
    ...
    <tbody>      ${props.bans.length === 0 ? html`
      ...
      <tr>
        <td><a href="/player/${ban.id}" style="color:var(--label-1);text-decoration:none;font-family:var(--sans);font-weight:600;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">${escHtml(ban.nickname)}</a></td>
