...
<table class="glass-table">
  ...
  <tbody>
    ...
    : props.bans.map(b => html`<tr id="banRow${b.id}">
      ...
      <td><a href="/player/${b.steam_id}" style="color:var(--label-1);text-decoration:none;font-family:var(--sans);font-weight:600;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">${escHtml(b.nickname)}</a></td>
