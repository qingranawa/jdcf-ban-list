...
<div class="cyber-admin-content">
  ...
  <!-- bottom action bar -->
  <div style="position:sticky;bottom:0;z-index:10;margin-top:var(--spacing-lg);padding:var(--spacing-md) 0;border-top:1px solid var(--separator);display:flex;gap:var(--spacing-md);align-items:center;background:rgba(0,0,0,.55);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);">
